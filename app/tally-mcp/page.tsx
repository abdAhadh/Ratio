...
export default async function TallyMcpPage() {
  ...
  return (
    <div className="min-h-screen bg-cream flex flex-col">
      ...
      {/* Hero */}
      <main className="flex-1 flex flex-col items-center justify-center px-5 md:px-10 py-10 md:py-14 text-center relative overflow-hidden">
        {/* Soft blur accents */}
        <div
          aria-hidden="true"
        ...
        {/* Headline */}
        <h1
          className="relative z-10 font-bold text-navy leading-[1.05] tracking-[-0.035em] mb-5 max-w-[900px]"
        ...
        {/* Subhead */}
        <p
          className="relative z-10 font-normal text-text-secondary leading-relaxed max-w-[520px] mb-7"
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center gap-3 mb-12">
          <a
            href="https://app.tryratio.io/sign-up"
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-navy text-white text-[14px] font-medium rounded-full hover:bg-navy-light transition-colors w-full sm:w-auto"
          >
          ...
          <a
            href="https://app.tryratio.io/sign-in"
            className="inline-flex items-center justify-center px-5 py-2.5 bg-transparent text-navy text-[14px] font-medium rounded-full border border-border hover:bg-cream-dark transition-colors w-full sm:w-auto"
          >
            Sign in
          </a>
        </div>
        ...
        <div className="relative z-10 w-full max-w-[1080px] text-center">
          <p className="text-[10px] font-medium tracking-[0.22em] uppercase text-text-secondary mb-4">
            Available Now
          </p>
          ...
          <p className="text-[10px] font-medium tracking-[0.22em] uppercase text-text-secondary opacity-70 mb-4">
            More coming soon
          </p>
          <div className="flex items-center justify-center gap-x-10 gap-y-4 flex-wrap opacity-80">
            <span className="flex items-center justify-center h-[38px]" aria-label="SAP">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ height: "38px", width: "auto" }}>
                <path
            ...
            <span className="flex items-center justify-center h-[38px]" aria-label="Acumatica">
              <svg viewBox="0 0 339.3 85" xmlns="http://www.w3.org/2000/svg" style={{ height: "24px", width: "auto" }}>
                <path
                  fill="#49C8F5"
            ...
            <span className="flex items-center justify-center h-[38px]" aria-label="Epicor">
              <svg viewBox="0 0 136 18" xmlns="http://www.w3.org/2000/svg" style={{ height: "16px", width: "auto" }}>
                <path
            ...
            <span className="flex items-center justify-center h-[38px]" aria-label="Infor">
              <svg viewBox="0 0 402.78668 371.70667" xmlns="http://www.w3.org/2000/svg" style={{ height: "37px", width: "auto" }}>
