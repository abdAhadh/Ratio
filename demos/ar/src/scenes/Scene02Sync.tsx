...
const INTEGRATIONS = [
  { name: 'Tally',          logo: `${base}logos/tally.svg`,      color: '#ED1C24' },
  { name: 'Zoho Books',     logo: `${base}logos/zoho-books.svg`, color: '#226DB4' },
  { name: 'SAP',            logo: `${base}logos/sap.svg`,        color: '#1870C5' },
  { name: 'QuickBooks',     logo: `${base}logos/quickbooks.svg`, color: '#2CA01C' },
  { name: 'Razorpay',       logo: `${base}logos/razorpay.svg`,   color: '#3395FF' },
  { name: 'Oracle NetSuite',logo: `${base}logos/netsuite.svg`,   color: '#E41817' },
];
